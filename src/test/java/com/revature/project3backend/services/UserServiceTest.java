...
class UserServiceTest {
    ...
    void loginValidUser() {
        ...
        String pass = "pass123";
        User user = new User(1, "john", "doe", "jdoe@mail.com"
                , "jdoe1", pass, items, transactions);
        ...
        } catch (InvalidCredentialsException e) { e.printStackTrace(); }
    ...
    void getUserByValidUserName() {
        ...
        List<Transaction> transactions = new ArrayList<>();
        User user = new User(1, "john", "doe", "jdoe@mail.com"
                , "jdoe1", "pass123", items, transactions);
